...
const translations: Record<string, Record<string, string>> = {
  ...
  es: {
    ...
    "hero.aiInsights": "Ahora con Insights de Portafolio con IA",
    ...
    "dashboard.totalPortfolioValue": "Valor Total del Portafolio",
