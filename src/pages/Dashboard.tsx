        ...
        <div className="pb-10 px-4 max-w-7xl mx-auto pt-6">
          <div className="mb-8 flex items-center justify-between">
            ...
            <div className="hidden sm:flex items-center gap-3">
              ...
              <AnimatedCoin symbol="$" delay={1} color="linear-gradient(135deg, hsl(160 84% 39%), hsl(160 84% 50%))" />
            </div>
          </div>
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                <motion.div
                  ...
                  animate={{ boxShadow: ["0 0 0px hsl(217 91% 60% / 0)", "0 0 20px hsl(217 91% 60% / 0.4)", "0 0 0px hsl(217 91% 60% / 0)"] }}
            ...
            >
              ...
              <ResponsiveContainer width="100%" height={220}>
                <AreaChart data={profitLossData}>
                  ...
                  />
                  <Area type="monotone" dataKey="value" stroke="hsl(160, 84%, 39%)" strokeWidth={2.5} fill="url(#plGrad)" />
                </AreaChart>
              </ResponsiveContainer>
            </motion.div>
